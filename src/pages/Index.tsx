...
const Index = () => {
  ...
  return <div className="min-h-screen bg-background text-foreground flex flex-col relative overflow-hidden">
      ...
      <header className="border-b border-border/50 p-4 glass-effect relative z-10">
        <div className="max-w-5xl mx-auto animate-fade-in">
          <div className="flex items-center gap-3 mb-1">
            <img src="/lovable-uploads/9cfc5456-ac14-4b16-828a-07d57519a111.png" alt="Seraphim Logo" className="w-8 h-8" />
      ...
      <main className="flex-1 flex items-center justify-center p-6 md:p-8 relative z-10">
        <div className="w-full max-w-5xl animate-slide-up">
          {!videoId ? <div className="space-y-8 text-center">
            ...
            </div> : <VideoPlayer videoId={videoId} onVideoEnd={handleVideoEnd} onNewVideo={() => {
          setVideoId('');
          setIsPlaying(false);
        }} />}
        </div>
